...
const ApplyJob = () => {
  ...
  return jobData ? (
    ...
    <div className='min-h-screen flex flex-col py-10 container px-4 2xl:px-20 mx-auto'>
      <div className='bg-white rounded w-full text-black'>
        <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl '>
          ...
          <div className='flex flex-col justify-center text-sm max-md:mx-auto max-md:text-center '>
            ...
            <p className='mt-1 text-gray-600'>Posted {moment(jobData.date).fromNow()} minuites ago</p>
          </div>
        </div>

        <div className='flex items-start flex-col lg:flex-row justify-between'>
          <div className='w-full lg:w-2/3'>
            <h2 className='font-bold text-2xl mt-4'>Job Description</h2>
