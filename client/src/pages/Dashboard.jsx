    ...
    <div className='min-h-screen'>
      ...
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
          <img onClick={e=>navigate('/')} className='maz-sm:w-32 cursor-pointer' src={assets.logo} alt="" />
      ...
      <div className='flex items-start'>
        {/* -------Left side bat with options add job,view applictaions */}
        <div className='inline-block min-h-screen border-r-2'>
          <ul className='flex text-gray-800 flex-col pt-5 items-start'>
